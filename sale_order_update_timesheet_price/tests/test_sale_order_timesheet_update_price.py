...
class TestSaleOrderTimesheetUpdatePrice(common.TransactionCase):
    ...
    def test_update_so_line_price_unit(self):
        ...
        self.assertFalse(initial_so_line.show_update_price_btn)
        ...
        self.assertTrue(initial_so_line.show_update_price_btn)
        self.assertFalse(initial_so_line.price_unit_updated)
        ...
        self.assertFalse(updated_so_line.show_update_price_btn)
